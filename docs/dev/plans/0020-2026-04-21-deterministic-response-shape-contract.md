...
- `pnpm vitest run tests/runtime.stepOutputContract.test.ts tests/runtime.configuredExecutor.test.ts`
...
- Add API request support for selecting the contract without editing team role
  config.
