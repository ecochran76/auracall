# Service Volatility Refactor Plan | 0012-2026-04-14
...
- the current need is stable canonical placement for the umbrella plan, not a semantic rewrite of the volatility program
- the old loose path will remain searchable in the legacy archive once the canonical umbrella is wired
