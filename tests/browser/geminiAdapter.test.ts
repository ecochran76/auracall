...
describe('geminiAdapter id helpers', () => {
  ...
  test('normalizes Gemini feature signatures from drawer choices and toggles', () => {
    expect(JSON.parse(normalizeGeminiFeatureSignature({
      ...
      disabled_modes: ['Create video', 'Create music', 'Unknown thing', 'Create video'],
      toggles: {
      ...
      signed_out: true,
      active_mode: 'fast',
      disabled_modes: ['create music', 'create video'],
      ...
      sections: {
        ...
        menuItems: [
          ...
          },
          {
            ...
            title: null,
            dataTestId: null,
            className: 'toolbox-drawer-item-list-button disabled mdc-list-item--disabled',
            href: null,
            checked: false,
            expanded: null,
            disabled: true,
        ...
        links: [
          {
            ...
            widgetType: 'link',
            pathHint: null,
            interactionHints: ['link-navigation'],
          },
        ],
        dialogs: [],
        menus: [],
