...
<div id="mirrorTargetTable"><table id="mirrorTargetAccounts"><tr data-mirror-target-row="true" data-mirror-target-completeness="in_progress" data-mirror-target-attention="false"><td data-mirror-target-attention-reason="true">backfill remains incomplete</td></tr></table></div>
...
<script>
  ...
  function formatMirrorTargetAttentionReason() { return 'no attention needed'; }
