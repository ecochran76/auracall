...
export interface BrowserProvider {
	...
	listProjectFiles?: (projectId: string, options?: BrowserProviderListOptions) => Promise<unknown>;
	listAccountFiles?: (options?: BrowserProviderListOptions) => Promise<unknown>;
	...
	uploadAccountFiles?: (filePaths: string[], options?: BrowserProviderListOptions) => Promise<void>;
	deleteProjectFile?: (
		projectId: string,
		fileName: string,
		options?: BrowserProviderListOptions,
	) => Promise<void>;
	deleteAccountFile?: (fileId: string, options?: BrowserProviderListOptions) => Promise<void>;
	downloadAccountFile?: (
		fileId: string,
		destPath: string,
		options?: BrowserProviderListOptions,
