...
export const STATIC_WORKBENCH_CAPABILITY_CATALOG: WorkbenchCapability[] = [
  ...
  },
  {
    ...
    safety: {
      ...
      notes: ['Shopping availability and downstream merchant interactions are account and rollout dependent.'],
    },
    source: 'static_catalog',
  },
  {
  ...
  },
  {
    ...
    safety: {
      requiresUserConsent: true,
      notes: ['Exact-ID Skill selection is supported through Try in chat; selection does not submit or prove invocation.'],
    },
    source: 'static_catalog',
    metadata: {
