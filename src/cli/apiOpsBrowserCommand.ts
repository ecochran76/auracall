...
export function formatApiOpsBrowserStatusCliSummary(summary: ApiOpsBrowserStatusSummary): string {
  ...
  return [
    ...
    `Dashboard service control: nav=${formatBoolean(dashboard.hasNavigationScaffold)} operations=${formatBoolean(dashboard.hasOperationsPanel)} apiService=${formatBoolean(dashboard.hasApiServiceControls)} apiLogTail=${formatBoolean(dashboard.hasApiLogTailControl)} preflight=${formatBoolean(dashboard.hasPreflightStatusPanel)} backgroundDrain=${formatBoolean(dashboard.hasBackgroundDrainControls)} scheduler=${formatBoolean(dashboard.hasMirrorSchedulerControls)} runOnce=${formatBoolean(dashboard.hasRunOnceSchedulerControl)}`,
